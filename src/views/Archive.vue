        ...
        <jptb>
            <div id="wrapper" v-if="archive">
                <div id="paper" :style="{width: getWidth + 'px'}">
                    ...
                    <div id="illus"><img src="https://i.loli.net/2020/04/15/WTsgaqiJfVdrRYC.png"
                    ...
                    <div id="main">
                        ...
                        <div v-for="(item, index) in time" :key="index">
                            ...
                            <hr />
                            <p v-for="(el, i) in item" :key="i" class="container" @mouseenter="mouseenter"><a
                                    @click="gotoPost(el)" :class="['link', 'link' + i]">{{el.title}}</a></p>
                        </div>
                    </div>
                </div>
            </div>
